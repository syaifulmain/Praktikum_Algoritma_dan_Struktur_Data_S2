...
public class PencarianBuku15 {
    ...
    public PencarianBuku15() {
        listBuku = new Buku[]{
                ...
                new Buku("666", "Buku m", 2021, "Pengarang F", 10),
                new Buku("888", "Buku c", 2021, "Pengarang H", 10),
                new Buku("444", "Buku e", 2021, "Pengarang D", 10),
                new Buku("999", "Buku z", 2021, "Pengarang I", 10),
                new Buku("555", "Buku g", 2021, "Pengarang E", 10),
                new Buku("777", "Buku h", 2021, "Pengarang G", 10),
                new Buku("333", "Buku i", 2021, "Pengarang C", 10),
        };
    }
